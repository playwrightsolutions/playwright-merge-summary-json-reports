...
var fs = require("fs");
function mergeSummary(directories) {
    return __awaiter(this, void 0, void 0, function () {
        var combined, newJsonPath;
        return __generator(this, function (_a) {
            ...
            directories.forEach(function (directory) {
                var summaryPath = directory + "/summary.json";
                try {
                    var json = require(summaryPath);
            ...
            newJsonPath = "./summary.json";
            fs.writeFileSync(newJsonPath, JSON.stringify(combined, null, "  "));
            console.log("Successfully merged ".concat(directories.length, " summary.json files"));
